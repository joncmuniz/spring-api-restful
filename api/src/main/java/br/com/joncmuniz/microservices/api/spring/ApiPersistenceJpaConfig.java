...
@ComponentScan({ "br.com.joncmuniz.microservices.api.persistence" })
@PropertySource({ "classpath:persistence-${persistenceTarget:h2}.properties" })
@EnableJpaRepositories(basePackages = "br.com.joncmuniz.microservices.api.persistence.dao")
public class ApiPersistenceJpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "br.com.joncmuniz.microservices" });
